...
fun SearchableProjectDropdown(
    projects: List<com.mahchin.app.data.model.Project>,
    selected: com.mahchin.app.data.model.Project?,
    onSelect: (com.mahchin.app.data.model.Project) -> Unit,
    modifier: androidx.compose.ui.Modifier = androidx.compose.ui.Modifier
) {
    androidx.compose.material3.Text("dropdown")
}
